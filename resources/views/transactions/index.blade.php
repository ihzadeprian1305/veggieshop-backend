                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="border px-6 py-4">Vegetable</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-6 py-4">{{ $item->vegetable->name }}</td>
                            ...
                            <td class="border px-6 py-4 text-center">
                                <a href="{{route('transactions.show', $item->id)}}" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mx-2 rounded">Detail Transaction</a>
